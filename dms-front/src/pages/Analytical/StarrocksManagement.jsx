...
const StarrocksManagement = () => {
  ...
  const [instances, setInstances] = useState([
    { id: 1, name: '生产StarRocks实例1', host: '192.168.5.10', port: 9030, username: 'admin', status: 'running' },
    { id: 2, name: '测试StarRocks实例2', host: '192.168.5.11', port: 9030, username: 'test', status: 'stopped' }
  ]);

  // Mock data for databases
  const [databases, setDatabases] = useState([
    { id: 1, name: 'analytics_sr', instance: '生产StarRocks实例1', size: '80GB', tables: 20 },
    { id: 2, name: 'test_sr', instance: '测试StarRocks实例2', size: '15GB', tables: 6 }
  ]);

  // Mock data for tables
  const [tables, setTables] = useState([
    { id: 1, name: 'user_behavior', database: 'analytics_sr', rows: 2000000, size: '40GB' },
    { id: 2, name: 'sales_data', database: 'analytics_sr', rows: 1000000, size: '25GB' }
  ]);
  ...
  return (
    <div>
      <div style={{ marginBottom: '24px' }}>
        <h2 style={{ margin: 0 }}>StarRocks管理</h2>
        <p style={{ color: '#666', marginTop: '8px' }}>管理StarRocks实例、数据库和表</p>
      </div>
...
export default StarrocksManagement;