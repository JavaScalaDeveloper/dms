...
const TidbManagement = () => {
  ...
  const [instances, setInstances] = useState([
    { id: 1, name: '生产TiDB实例1', host: '192.168.2.10', port: 4000, username: 'admin', status: 'running' },
    { id: 2, name: '测试TiDB实例2', host: '192.168.2.11', port: 4000, username: 'test', status: 'stopped' }
  ]);

  // Mock data for databases
  const [databases, setDatabases] = useState([
    { id: 1, name: 'tidb_production', instance: '生产TiDB实例1', size: '20GB', tables: 30 },
    { id: 2, name: 'tidb_test', instance: '测试TiDB实例2', size: '5GB', tables: 12 }
  ]);

  // Mock data for tables
  const [tables, setTables] = useState([
    { id: 1, name: 'users', database: 'tidb_production', rows: 15000, size: '8MB' },
    { id: 2, name: 'transactions', database: 'tidb_production', rows: 100000, size: '30MB' }
  ]);
  ...
  return (
    <div>
      <div style={{ marginBottom: '24px' }}>
        <h2 style={{ margin: 0 }}>TiDB管理</h2>
        <p style={{ color: '#666', marginTop: '8px' }}>管理TiDB实例、数据库和表</p>
      </div>
