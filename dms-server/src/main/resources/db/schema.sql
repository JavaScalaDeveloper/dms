...
(
    ...
    related_test_instance_host VARCHAR(255) COMMENT '关联测试实例host',
    related_pre_instance_host  VARCHAR(255) COMMENT '关联预发实例host',
    related_prd_instance_host VARCHAR(255) COMMENT '关联生产实例host',
